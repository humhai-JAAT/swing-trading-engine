"""Stage 1 — ranking data layer. Fetches today's %-change for every stock
in the Nifty500 universe exactly ONCE per cycle, split across parallel
workers on multiple broker accounts.
"""
